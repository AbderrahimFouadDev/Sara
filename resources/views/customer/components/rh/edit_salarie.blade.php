{{-- resources/views/customer/components/rh/edit_salarie.blade.php --}}
<div class="employee-form-container">
    <div class="form-header">
        ...
        <p class="header-subtitle">Modifier les informations du salarié</p>
    </div>

    <form id="employeeForm" method="POST" action="{{ route('rh.salaries.update', $salarie->id) }}" class="employee-form" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-section">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <div class="photo-upload-section">
                        <div class="photo-preview-container">
                            <img id="photoPreview" src="{{ $salarie->photo ? asset('storage/'.$salarie->photo) : asset('images/default-avatar.png') }}" alt="Photo preview">
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nom_complet" name="nom_complet" required class="form-control" value="{{ old('nom_complet', $salarie->nom_complet) }}">
                </div>

                <div class="form-group">
                    <label for="cin">CIN *</label>
                    <input type="text" id="cin" name="cin" required class="form-control" value="{{ old('cin', $salarie->cin) }}">
                </div>

                <div class="form-group">
                    <label for="cnss">Numéro CNSS</label>
                    <input type="text" id="cnss" name="cnss" class="form-control" value="{{ old('cnss', $salarie->cnss) }}">
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="poste" name="poste" required class="form-control" value="{{ old('poste', $salarie->poste) }}">
                </div>

                <div class="form-group">
                    <label for="departement">Département *</label>
                    <input type="text" id="departement" name="departement" required class="form-control" value="{{ old('departement', $salarie->departement) }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="statut" name="statut" required class="form-control">
                        ...
                        <option value="congé" {{ old('statut', $salarie->statut) == 'congé' ? 'selected' : '' }}>En Congé</option>
                        <option value="quitté" {{ old('statut', $salarie->statut) == 'quitté' ? 'selected' : '' }}>Quitté</option>
                    </select>
                </div>
            </div>
        </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <select id="type_contrat" name="type_contrat" required class="form-control">
                        <option value="CDI" {{ old('type_contrat', $salarie->type_contrat) == 'CDI' ? 'selected' : '' }}>CDI</option>
                        <option value="CDD" {{ old('type_contrat', $salarie->type_contrat) == 'CDD' ? 'selected' : '' }}>CDD</option>
                        <option value="Stage" {{ old('type_contrat', $salarie->type_contrat) == 'Stage' ? 'selected' : '' }}>Stage</option>
                        <option value="Interim" {{ old('type_contrat', $salarie->type_contrat) == 'Interim' ? 'selected' : '' }}>Intérim</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="date_embauche" name="date_embauche" required class="form-control" 
                           value="{{ old('date_embauche', $salarie->date_embauche ? $salarie->date_embauche->format('Y-m-d') : '') }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="date_debut_contrat" name="date_debut_contrat" required class="form-control"
                           value="{{ old('date_debut_contrat', $salarie->date_debut_contrat ? $salarie->date_debut_contrat->format('Y-m-d') : '') }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="date_fin_contrat" name="date_fin_contrat" class="form-control"
                           value="{{ old('date_fin_contrat', $salarie->date_fin_contrat ? $salarie->date_fin_contrat->format('Y-m-d') : '') }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="salaire_base" name="salaire_base" required class="form-control" step="0.01"
                           value="{{ old('salaire_base', $salarie->salaire_base) }}">
                </div>
            </div>
        </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    @if($salarie->document_cin)
                        <small class="text-muted">Document actuel: {{ basename($salarie->document_cin) }}</small>
                    @endif
                </div>
                ...
                <div class="form-group">
                    ...
                    @if($salarie->document_cnss)
                        <small class="text-muted">Document actuel: {{ basename($salarie->document_cnss) }}</small>
                    @endif
                </div>
                ...
                <div class="form-group">
                    ...
                    @if($salarie->document_contrat)
                        <small class="text-muted">Document actuel: {{ basename($salarie->document_contrat) }}</small>
                    @endif
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (response.ok) {
                alert(data.message || 'Salarié modifié avec succès!');
            ...
            alert('Erreur lors de la modification du salarié: ' + error.message);
        } finally {
